...
using PTC.DOTIC.Web.Authentication.JwtBearer;
using PTC.DOTIC.Web.Authentication.TwoFactor;
using PTC.DOTIC.Web.Configuration;
#if FEATURE_SIGNALR
using Abp.Web.SignalR;
#endif

namespace PTC.DOTIC.Web
{
    [DependsOn(
    ...
    public class DOTICWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DOTICWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(DOTICApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DOTICWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(DOTICWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
