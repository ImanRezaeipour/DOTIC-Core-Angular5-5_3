...
using PTC.DOTIC.Controls;
using PTC.DOTIC.Core.Dependency;
using PTC.DOTIC.Extensions;
using PTC.DOTIC.Localization;
using PTC.DOTIC.UI;
using PTC.DOTIC.UI.Assets;
...
namespace PTC.DOTIC.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "DOTIC";
