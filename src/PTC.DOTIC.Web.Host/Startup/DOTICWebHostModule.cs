...
{
    [DependsOn(
        typeof(DOTICWebCoreModule)
    )]
    public class DOTICWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DOTICWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DOTICWebHostModule).GetAssembly());
        }
