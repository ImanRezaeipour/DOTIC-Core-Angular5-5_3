...
using PTC.DOTIC.Install.Dto;
using PTC.DOTIC.Migrations.Seed;
using PTC.DOTIC.Migrations.Seed.Host;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace PTC.DOTIC.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : DOTICAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<DOTICDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(DOTICConsts.ConnectionStringName).Value.ToString();
        }
