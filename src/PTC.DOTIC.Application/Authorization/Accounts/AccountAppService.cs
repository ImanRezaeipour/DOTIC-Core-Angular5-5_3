...
using PTC.DOTIC.Authorization.Accounts.Dto;
...
namespace PTC.DOTIC.Authorization.Accounts
{
    public class AccountAppService : DOTICAppServiceBase, IAccountAppService
    {
