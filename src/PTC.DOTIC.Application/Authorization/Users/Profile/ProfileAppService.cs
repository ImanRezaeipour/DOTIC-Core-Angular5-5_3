...
using PTC.DOTIC.Authentication.TwoFactor.Google;
using PTC.DOTIC.Authorization.Users.Dto;
using PTC.DOTIC.Authorization.Users.Profile.Cache;
...
using PTC.DOTIC.Timing;

namespace PTC.DOTIC.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : DOTICAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PTC.DOTIC",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PTC.DOTIC",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
