...
using PTC.DOTIC.Authorization.Permissions;
using PTC.DOTIC.Authorization.Permissions.Dto;
using PTC.DOTIC.Authorization.Roles.Dto;

namespace PTC.DOTIC.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : DOTICAppServiceBase, IRoleAppService
    {
