...
using PTC.DOTIC.MultiTenancy.Accounting;
using PTC.DOTIC.MultiTenancy.Payments;
using PTC.DOTIC.Storage;

namespace PTC.DOTIC.EntityFrameworkCore
{
    public class DOTICDbContext : AbpZeroDbContext<Tenant, Role, User, DOTICDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public DOTICDbContext(DbContextOptions<DOTICDbContext> options)
            : base(options)
        {
