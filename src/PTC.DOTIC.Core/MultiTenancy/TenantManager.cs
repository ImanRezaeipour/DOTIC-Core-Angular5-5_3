...
using PTC.DOTIC.MultiTenancy.Demo;
...
namespace PTC.DOTIC.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(DOTICConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
